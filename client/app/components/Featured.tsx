    ...
    <div className="overflow-hidden py-4 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg dark:text-white leading-8 text-gray-600">
                Unlock the potential of online education with EduForge. Explore
          ...
          <img
            src="https://res.cloudinary.com/dxypazeq8/image/upload/v1707145604/EduForgedemo_e2g5xj.png"
            alt="EduForge Features"
