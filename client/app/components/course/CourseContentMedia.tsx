...
//   useGetCourseDetailsQuery,
// } from "@/redux/features/courses/coursesApi";
// import { useUpdateProgressMutation } from "@/redux/features/progress/progressApi";
// import CommentReply from "./questions/CommentReply";
// import Reviews from "./Reviews/Reviews";
// import { Course } from "./Courses";
...
//   useEffect(() => {
//     updateProgress({ courseId, videoId: courseData[activeVideo]._id });
//   }, [activeVideo]);
...
//   const [updateProgress] = useUpdateProgressMutation();
//   const { data: progressData } = useGetProgressQuery(courseId);
...
//   const completedVideos = progressData?.completedVideos.length || 0;
